    ...
    return (
        <div>
            <form className="form">
                ...
                <input type='email' className='text-area'></input>
            ...
            <div className='download-btns'>
                <div className='apple button'>
                    ...
                    <img className='icon' src='https://w7.pngwing.com/pngs/640/461/png-transparent-apple-logo-company-apple-logo-company-service-computer.png' />
                ...
                <div className='play button'>
                    <img className='icon' src='https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Google_Play_Prism.max-1100x1100.png' />
                    <div className='content-wrapper'>
